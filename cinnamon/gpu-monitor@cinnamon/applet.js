...
MyApplet.prototype = {
    ...
    showChartWindow: function() {
        ...
        global.log("Chart window feature not yet implemented in Cinnamon version");
    },
    ...
    updateDisplay: function(info) {
        ...
        if (this.showChart) {
            // Chart mode - update individual charts
            ...
            if (this.showGpuLoad && info.gpuLoad !== null) {
                displayParts.push(info.gpuLoad + "%");
            }

            if (this.showTemperature && info.temperature !== null) {
                displayParts.push(info.temperature + "°C");
            }

            if (this.showMemory && info.memoryPercent !== null) {
                displayParts.push("Mem: " + info.memoryPercent + "%");
            }

            let text = displayParts.length > 0 ? "GPU: " + displayParts.join(" | ") : "GPU: --";
    ...
    updateChartDisplay: function() {
        // Remove text label and add charts
